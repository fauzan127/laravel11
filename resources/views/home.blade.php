                        ...
                        <div class="rounded-lg shadow-xl overflow-hidden border border-black">
                            <div class="relative max-h-[600px]"">
                                @if ($slider->image)
                                    ...
                                    <div class="absolute bottom-0 left-0 w-full p-6 rounded-b-lg bg-gradient-to-t from-white/80 to-black/30">
                                        <h3 class="text-xl font-semibold text-gray-900 hover:text-indigo-600 transition duration-300">
                                            {{ $slider->title }}
                                        </h3>
                                ...
                                @else
                                    <img src="https://stg-uploads.slidenest.com/template_2552/templateColor_2450/previewImages/beginner-coding-modern-powerpoint-google-slides-keynote-presentation-26.jpeg" alt="{{ $slider->title }}" 
                                        class="w-full object-cover rounded-lg">
                                    <div class="absolute bottom-0 left-0 w-full p-6 rounded-b-lg bg-gradient-to-t from-white/80 to-black/30">
                                        <h3 class="text-xl font-semibold text-gray-900 hover:text-indigo-600 transition duration-300">
                                            {{ $slider->title }}
